	...
	return (
		<section className="min-h-screen pt-[120px] sm:pt-[100px] lg:pt-[120px] py-6 sm:py-8 lg:py-12 px-4 bg-gradient-to-br from-hv-green/40 to-hv-beige-6">
			<div className="max-w-[1200px] mx-auto">
				<h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-hv-green font-beau mb-6 text-center">
					Psiholoske teme
				</h1>
				<hr />
				<div className="my-4 space-y-2 text-center">
					<p>
						Koliko puta ste osetili da vas nešto „boli“, a lekari kažu da je sve
						u redu?
					</p>
					...
					<p>
						Kada nas boli telo, mi to shvatamo ozbiljno i tražimo fizički uzrok.
					</p>
					<p>
						Ali kada boli duša ćutimo, guramo osećanja po strani i nastavljamo
						dalje.
					</p>
					<p>
