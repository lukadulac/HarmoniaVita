				...
				<nav className="flex flex-col items-center justify-center h-full space-y-8 text-2xl font-medium pt-20">
					<Link
						...
						className={`transition-colors ${
							isActive('/') ? 'text-hv-green-dark font-bold' : 'text-gray-700 hover:text-hv-green-dark'
						}`}
					>
						Početna
					</Link>
					<Link
						...
						onClick={closeMenu}
						className={`transition-colors ${
							isActive('/O-nama') ? 'text-hv-green-dark font-bold' : 'text-gray-700 hover:text-hv-green-dark'
						}`}
					>
						O nama
					</Link>
					<Link
						...
						onClick={closeMenu}
						className={`transition-colors ${
							isActive('/usluge') ? 'text-hv-green-dark font-bold' : 'text-gray-700 hover:text-hv-green-dark'
						}`}
					>
						Usluge
					</Link>
					<Link
						...
						onClick={closeMenu}
						className={`transition-colors ${
							isActive('/blog') ? 'text-hv-green-dark font-bold' : 'text-gray-700 hover:text-hv-green-dark'
						}`}
					>
						Blog
					</Link>
					<Link
						...
						onClick={closeMenu}
						className={`transition-colors ${
							isActive('/kontakt') ? 'text-hv-green-dark font-bold' : 'text-gray-700 hover:text-hv-green-dark'
						}`}
					>
						Kontakt
					</Link>
